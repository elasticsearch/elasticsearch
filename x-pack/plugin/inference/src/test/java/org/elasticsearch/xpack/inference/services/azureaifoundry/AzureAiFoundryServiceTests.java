...
import org.elasticsearch.xpack.inference.services.azureaifoundry.completion.AzureAiFoundryChatCompletionServiceSettingsTests;
import org.elasticsearch.xpack.inference.services.azureaifoundry.completion.AzureAiFoundryChatCompletionTaskSettingsTests;
import org.elasticsearch.xpack.inference.services.azureaifoundry.embeddings.AzureAiFoundryEmbeddingsModel;
import org.elasticsearch.xpack.inference.services.azureaifoundry.embeddings.AzureAiFoundryEmbeddingsModelTests;
import org.elasticsearch.xpack.inference.services.azureaifoundry.embeddings.AzureAiFoundryEmbeddingsServiceSettingsTests;
import org.elasticsearch.xpack.inference.services.azureaifoundry.embeddings.AzureAiFoundryEmbeddingsTaskSettingsTests;
...
import static org.elasticsearch.xpack.inference.services.azureaifoundry.AzureAiFoundryConstants.API_KEY_FIELD;
...
public class AzureAiFoundryServiceTests extends ESTestCase {
    ...
    public void testParseRequestConfig_CreatesAnAzureAiFoundryEmbeddingsModel() throws IOException {
        try (var service = createService()) {
            ActionListener<Model> modelVerificationListener = ActionListener.wrap(model -> {
                assertThat(model, instanceOf(AzureAiFoundryEmbeddingsModel.class));

                var embeddingsModel = (AzureAiFoundryEmbeddingsModel) model;
    ...
    public void testParseRequestConfig_CreatesAnAzureAiFoundryEmbeddingsModelWhenChunkingSettingsProvided() throws IOException {
        try (var service = createService()) {
            ActionListener<Model> modelVerificationListener = ActionListener.wrap(model -> {
                assertThat(model, instanceOf(AzureAiFoundryEmbeddingsModel.class));
    ...
    public void testParseRequestConfig_CreatesAnAzureAiFoundryEmbeddingsModelWhenChunkingSettingsNotProvided() throws IOException {
        try (var service = createService()) {
            ActionListener<Model> modelVerificationListener = ActionListener.wrap(model -> {
                assertThat(model, instanceOf(AzureAiFoundryEmbeddingsModel.class));
    ...
    public void testParseRequestConfig_CreatesAnAzureAiFoundryChatCompletionModel() throws IOException {
        try (var service = createService()) {
            ActionListener<Model> modelVerificationListener = ActionListener.wrap(model -> {
                assertThat(model, instanceOf(AzureAiFoundryChatCompletionModel.class));

                var completionModel = (AzureAiFoundryChatCompletionModel) model;
        ...
        try (var service = createService()) {
            ActionListener<Model> modelVerificationListener = ActionListener.wrap(
                ...
                exception -> {
                    ...
                    assertThat(exception.getMessage(), is("The [azureaifoundry] service does not support task type [sparse_embedding]"));
                }
            );
            ...
            ActionListener<Model> modelVerificationListener = ActionListener.wrap(
                ...
                exception -> {
                    ...
                    assertThat(
                        ...
                        is("Model configuration contains settings [{extra_key=value}] unknown to the [azureaifoundry] service")
                    );
                }
            );
    ...
    public void testParsePersistedConfig_CreatesAnAzureAiFoundryEmbeddingsModel() throws IOException {
        try (var service = createService()) {
    ...
    public void testParsePersistedConfig_CreatesAnAzureAiFoundryChatCompletionModel() throws IOException {
        try (var service = createService()) {
            var config = getPersistedConfigMap(
                getChatCompletionServiceSettingsMap(DEFAULT_TARGET, DEFAULT_DEPLOYMENT_TYPE.toString(), DEFAULT_MODEL),
            ...
            var chatCompletionModel = (AzureAiFoundryChatCompletionModel) model;
    ...
    public void testParsePersistedConfigWithSecrets_ThrowsErrorTryingToParseInvalidModel() throws IOException {
        try (var service = createService()) {
            ...
            assertThat(
                ...
                is("Failed to parse stored model [id] for [azureaifoundry] service, please delete and add the service again")
            );
        }
    }
    ...
    public void testCheckModelConfig_ForEmbeddingsModel_Works() throws IOException {
        ...
        try (var service = new AzureAiFoundryService(senderFactory, createWithEmptySettings(threadPool))) {
            webServer.enqueue(new MockResponse().setResponseCode(200).setBody(testEmbeddingResultJson));

            var model = AzureAiFoundryEmbeddingsModelTests.createModel(
                "id",
                getUrl(webServer),
            ...
            assertThat(
                result,
                is(
                    AzureAiFoundryEmbeddingsModelTests.createModel(
                        "id",
                        getUrl(webServer),
                        DEFAULT_DEPLOYMENT_TYPE,
                        DEFAULT_MODEL,
    ...
    public void testCheckModelConfig_WorksForChatCompletionsModel() throws IOException {
        ...
        try (var service = new AzureAiFoundryService(senderFactory, createWithEmptySettings(threadPool))) {
            ...
            var model = AzureAiFoundryChatCompletionModelTests.createModel(
                "id",
                getUrl(webServer),
                DEFAULT_DEPLOYMENT_TYPE,
                DEFAULT_MODEL,
            ...
            assertThat(
                result,
                is(
                    AzureAiFoundryChatCompletionModelTests.createModel(
                        "id",
                        getUrl(webServer),
                        DEFAULT_DEPLOYMENT_TYPE,
                        DEFAULT_MODEL,
                        ...
                        null,
                        null,
                        AzureAiFoundryChatCompletionTaskSettings.DEFAULT_MAX_TOKENS,
                        null
                    )
                )
            );
    ...
    private void testUpdateModelWithChatCompletionDetails_Successful(Integer maxNewTokens) throws IOException {
        ...
        try (var service = new AzureAiFoundryService(senderFactory, createWithEmptySettings(threadPool))) {
            ...
            assertThat(updatedModel, instanceOf(AzureAiFoundryChatCompletionModel.class));
            AzureAiFoundryChatCompletionTaskSettings updatedTaskSettings = (AzureAiFoundryChatCompletionTaskSettings) updatedModel
                .getTaskSettings();
    ...
    public void testInfer_ThrowsErrorWhenModelIsNotAzureAiFoundryModel() throws IOException {
        ...
        try (var service = new AzureAiFoundryService(factory, createWithEmptySettings(threadPool))) {
    ...
    private void testChunkedInfer(AzureAiFoundryEmbeddingsModel model) throws IOException {
        var senderFactory = HttpRequestSenderTests.createSenderFactory(threadPool, clientManager);
            ...
            String content = XContentHelper.stripWhitespace("""
                {
                    ...
                    "configurations": {
                        ...
                        "target": {
                            "description": "The target URL of your Azure AI Foundry model deployment.",
                            "label": "Target",
                            "required": true,
                            "sensitive": false,
                            "updatable": false,
    ...
    public void testSupportsStreaming() throws IOException {
        try (var service = new AzureAiFoundryService(mock(), createWithEmptySettings(mock()))) {
    ...
    private AzureAiFoundryService createService() {
        return new AzureAiFoundryService(mock(HttpRequestSender.Factory.class), createWithEmptySettings(threadPool));
    }
    ...
    private static Map<String, Object> getEmbeddingsServiceSettingsMap(
        ...
        return AzureAiFoundryEmbeddingsServiceSettingsTests.createRequestSettingsMap(
            target,
            deploymentType,
            model,
            dimensions,
    ...
    private static Map<String, Object> getEmbeddingsTaskSettingsMap(@Nullable String user) {
        return AzureAiFoundryEmbeddingsTaskSettingsTests.getTaskSettingsMap(user);
    }
    ...
    private static HashMap<String, Object> getChatCompletionServiceSettingsMap(String target, String deploymentType, String model) {
        return AzureAiFoundryChatCompletionServiceSettingsTests.createRequestSettingsMap(target, deploymentType, model);
    }
    ...
    public static Map<String, Object> getChatCompletionTaskSettingsMap(
        ...
        return AzureAiFoundryChatCompletionTaskSettingsTests.getTaskSettingsMap(temperature, topP, doSample, maxTokens);
    }
