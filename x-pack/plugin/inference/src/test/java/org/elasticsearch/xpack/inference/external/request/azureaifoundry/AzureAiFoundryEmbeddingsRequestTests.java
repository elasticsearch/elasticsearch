...
public class AzureAiFoundryEmbeddingsRequestTests extends ESTestCase {
    ...
    public static AzureAiFoundryEmbeddingsRequest createRequest(
        String target,
        ...
        return new AzureAiFoundryEmbeddingsRequest(
