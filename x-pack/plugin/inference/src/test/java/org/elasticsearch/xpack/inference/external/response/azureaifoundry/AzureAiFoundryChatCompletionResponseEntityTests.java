...
public class AzureAiFoundryChatCompletionResponseEntityTests extends ESTestCase {

    public void testCompletionResponse_FromModelInferenceServiceDeployment() throws IOException {
        var entity = new AzureAiFoundryChatCompletionResponseEntity();
        ...
        var request = new AzureAiFoundryChatCompletionRequest(model, List.of("test input"), false);
