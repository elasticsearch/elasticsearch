...
import static org.elasticsearch.xpack.inference.services.azureaifoundry.completion.AzureAiFoundryChatCompletionTaskSettingsTests.getTaskSettingsMap;
import static org.hamcrest.Matchers.is;
import static org.hamcrest.Matchers.sameInstance;

public class AzureAiFoundryChatCompletionModelTests extends ESTestCase {
    ...
    public void testOverrideWith_OverridesWithoutValues() {
        ...
        var overriddenModel = AzureAiFoundryChatCompletionModel.of(model, requestTaskSettingsMap);
    ...
    public void testOverrideWith_temperature() {
        ...
        var overriddenModel = AzureAiFoundryChatCompletionModel.of(model, requestTaskSettings);
        assertThat(
            overriddenModel,
            is(
                createModel(
    ...
    public static AzureAiFoundryChatCompletionModel createModel(
        String id,
        String target,
    ...
    public static AzureAiFoundryChatCompletionModel createModel(
        ...
        return new AzureAiFoundryChatCompletionModel(
            id,
            TaskType.COMPLETION,
            "azureaifoundry",
            new AzureAiFoundryChatCompletionServiceSettings(target, deploymentType, deploymentName, rateLimitSettings),
            new AzureAiFoundryChatCompletionTaskSettings(temperature, topP, doSample, maxNewTokens),
