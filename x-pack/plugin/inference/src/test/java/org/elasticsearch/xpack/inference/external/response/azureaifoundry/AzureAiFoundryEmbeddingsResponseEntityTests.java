...
/**
 * Note - the underlying AzureAiFoundryEmbeddingsResponseEntity uses the same
 * response entity parser as OpenAI. This test just performs a smoke
 * test of the wrapper
 */
public class AzureAiFoundryEmbeddingsResponseEntityTests extends ESTestCase {
    public void testFromResponse_CreatesResultsForASingleItem() throws IOException {
        ...
        var entity = new AzureAiFoundryEmbeddingsResponseEntity();
