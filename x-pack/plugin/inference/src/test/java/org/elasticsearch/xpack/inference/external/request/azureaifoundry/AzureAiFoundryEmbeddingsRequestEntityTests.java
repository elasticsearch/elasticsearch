...
public class AzureAiFoundryEmbeddingsRequestEntityTests extends ESTestCase {
    public void testXContent_WritesUserWhenDefined() throws IOException {
        var entity = new AzureAiFoundryEmbeddingsRequestEntity(
            AzureAiFoundryDeploymentType.AZURE_AI_MODEL_INFERENCE_SERVICE, "test-model",
