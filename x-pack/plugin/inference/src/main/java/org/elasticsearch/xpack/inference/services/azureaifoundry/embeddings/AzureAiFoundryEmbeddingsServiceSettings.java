...
public class AzureAiFoundryEmbeddingsServiceSettings extends AzureAiFoundryServiceSettings {
    ...
    public static AzureAiFoundryEmbeddingsServiceSettings fromMap(Map<String, Object> map, ConfigurationParseContext context) {
        ...
        return new AzureAiFoundryEmbeddingsServiceSettings(settings);
    }

    private static AzureAiFoundryEmbeddingCommonFields embeddingSettingsFromMap(
        ...
        return new AzureAiFoundryEmbeddingCommonFields(baseSettings, dims, dimensionsSetByUser, maxTokens, similarity);
    }

    private record AzureAiFoundryEmbeddingCommonFields(
        BaseAzureAiFoundryCommonFields baseCommonFields,
    ...
    public AzureAiFoundryEmbeddingsServiceSettings(
        String target,
    ...
    public AzureAiFoundryEmbeddingsServiceSettings(StreamInput in) throws IOException {
        super(in);
    ...
    private AzureAiFoundryEmbeddingsServiceSettings(AzureAiFoundryEmbeddingCommonFields fields) {
        this(
    ...
    public boolean equals(Object o) {
        ...
        AzureAiFoundryEmbeddingsServiceSettings that = (AzureAiFoundryEmbeddingsServiceSettings) o;
