 ...
 * {@link AzureAiFoundryEmbeddingsTaskSettings} is that this class considers all fields as optional. It will not throw an error if a field
 ...
 */
public record AzureAiFoundryEmbeddingsRequestTaskSettings(@Nullable String user) {
    public static final AzureAiFoundryEmbeddingsRequestTaskSettings EMPTY_SETTINGS = new AzureAiFoundryEmbeddingsRequestTaskSettings(null);
     ...
     */
    public static AzureAiFoundryEmbeddingsRequestTaskSettings fromMap(Map<String, Object> map) {
        if (map.isEmpty()) {
            return AzureAiFoundryEmbeddingsRequestTaskSettings.EMPTY_SETTINGS;
        }
        ...
        return new AzureAiFoundryEmbeddingsRequestTaskSettings(user);
    }
