...
public class AzureAiFoundryEmbeddingsTaskSettings implements TaskSettings {
    ...
    public static AzureAiFoundryEmbeddingsTaskSettings fromMap(Map<String, Object> map) {
        ...
        return new AzureAiFoundryEmbeddingsTaskSettings(user);
    }
     ...
     */
    public static AzureAiFoundryEmbeddingsTaskSettings of(
        AzureAiFoundryEmbeddingsTaskSettings originalSettings,
        AzureAiFoundryEmbeddingsRequestTaskSettings requestSettings
    ) {
        var userToUse = requestSettings.user() == null ? originalSettings.user : requestSettings.user();
        return new AzureAiFoundryEmbeddingsTaskSettings(userToUse);
    }

    public AzureAiFoundryEmbeddingsTaskSettings(@Nullable String user) {
        this.user = user;
    }

    public AzureAiFoundryEmbeddingsTaskSettings(StreamInput in) throws IOException {
    ...
    public boolean equals(Object o) {
        ...
        AzureAiFoundryEmbeddingsTaskSettings that = (AzureAiFoundryEmbeddingsTaskSettings) o;
    ...
    public TaskSettings updatedTaskSettings(Map<String, Object> newSettings) {
        AzureAiFoundryEmbeddingsRequestTaskSettings requestSettings = AzureAiFoundryEmbeddingsRequestTaskSettings.fromMap(
            new HashMap<>(newSettings)
        );
        return AzureAiFoundryEmbeddingsTaskSettings.of(this, requestSettings);
    }
}
