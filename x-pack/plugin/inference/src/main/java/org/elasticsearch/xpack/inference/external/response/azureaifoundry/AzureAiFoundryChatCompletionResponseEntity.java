...
public class AzureAiFoundryChatCompletionResponseEntity extends BaseResponseEntity {

    @Override
    protected InferenceServiceResults fromResponse(Request request, HttpResult response) throws IOException {
        if (request instanceof AzureAiFoundryChatCompletionRequest asChatCompletionRequest) {
